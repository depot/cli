...
const (
	...
	OrganizationServiceName = "depot.core.v1.OrganizationService"
)
...
const (
	...
	OrganizationServiceListOrganizationsProcedure = "/depot.core.v1.OrganizationService/ListOrganizations"
)
...
func NewOrganizationServiceHandler(svc OrganizationServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/depot.core.v1.OrganizationService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
