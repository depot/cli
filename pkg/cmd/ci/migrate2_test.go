...
func TestRunMigrate2_NoGitHub(t *testing.T) {
	dir := t.TempDir()
	var buf bytes.Buffer
	opts := migrate2Options{
		yes:    true,
		dir:    dir,
		stdout: &buf,
	}
...
func TestRunMigrate2_NoWorkflows(t *testing.T) {
	dir := t.TempDir()
...
func TestRunMigrate2_BasicMigration(t *testing.T) {
	dir := t.TempDir()
...
func TestRunMigrate2_WithUnsupportedTrigger(t *testing.T) {
	dir := t.TempDir()
	workflowsDir := filepath.Join(dir, ".github", "workflows")
	os.MkdirAll(workflowsDir, 0755)
...
func TestRunMigrate2_WithSecrets(t *testing.T) {
	dir := t.TempDir()
	workflowsDir := filepath.Join(dir, ".github", "workflows")
	os.MkdirAll(workflowsDir, 0755)
...
func TestRunMigrate2_DisabledJob(t *testing.T) {
	dir := t.TempDir()
	workflowsDir := filepath.Join(dir, ".github", "workflows")
	os.MkdirAll(workflowsDir, 0755)
...
func TestRunMigrate2_OverwriteExisting(t *testing.T) {
	dir := t.TempDir()
	workflowsDir := filepath.Join(dir, ".github", "workflows")
	os.MkdirAll(workflowsDir, 0755)
...
func TestRunMigrate2_MultipleWorkflows(t *testing.T) {
	dir := t.TempDir()
	workflowsDir := filepath.Join(dir, ".github", "workflows")
	os.MkdirAll(workflowsDir, 0755)
