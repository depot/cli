...
// csv format.
func composeToBuildkitSecret(inp compose.ServiceSecretConfig, psecret compose.SecretConfig) (*buildflags.Secret, error) {
	if psecret.External {
...
// csv format.
func composeToBuildkitSSH(sshKey compose.SSHKey) *buildflags.SSH {
