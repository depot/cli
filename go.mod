...
replace (
	github.com/docker/buildx => github.com/depot/buildx v0.11.3-0.20230908020957-308e71ac8580
	github.com/moby/buildkit => github.com/depot/buildkit v0.11.0-rc3.0.20230906231722-f32d4e83d00d
